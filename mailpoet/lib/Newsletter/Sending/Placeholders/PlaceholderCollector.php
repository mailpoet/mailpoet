...
/**
 * Issues `{{mailpoet_mss_<namespace>_<n>}}` placeholders for the per-recipient parts of an email
...
class PlaceholderCollector {
  ...
  /** The placeholder without its braces, e.g. "mailpoet_mss_<namespace>_", followed by the index. */
  public function getPlaceholderPrefix(): string {
    return 'mailpoet_mss_' . $this->namespace . '_';
  }
