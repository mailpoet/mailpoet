...
class ContainerConfigurator implements IContainerConfigurator {
  ...
  public function configure(ContainerBuilder $container) {
    ...
    $container->autowire(\MailPoet\WordPress\TransactionalEmails\WpTransactionalEmailTemplates::class)->setPublic(true);
    $container->autowire(\MailPoet\WordPress\TransactionalEmails\WpTransactionalEmailManager::class)->setPublic(true);
