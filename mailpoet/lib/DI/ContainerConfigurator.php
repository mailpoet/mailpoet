...
class ContainerConfigurator implements IContainerConfigurator {
  ...
  public function configure(ContainerBuilder $container) {
    ...
    $container->autowire(\MailPoet\Automation\Integrations\Core\Triggers\ScheduledDateTimeTrigger::class)->setPublic(true)->setShared(false);
    $container->autowire(\MailPoet\Automation\Integrations\Core\Triggers\ScheduledDateTimeHooks::class)->setPublic(true);
