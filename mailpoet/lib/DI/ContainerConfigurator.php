...
class ContainerConfigurator implements IContainerConfigurator {
  ...
  public function configure(ContainerBuilder $container) {
    ...
    $container->autowire(\MailPoet\Automation\Integrations\MailPoet\Subjects\OrderSubject::class)->setPublic(true)->setShared(false);
    $container->autowire(\MailPoet\Automation\Integrations\MailPoet\Subjects\OrderStatusChangeSubject::class)->setPublic(true)->setShared(false);
    $container->autowire(\MailPoet\Automation\Integrations\MailPoet\Subjects\CustomerSubject::class)->setPublic(true)->setShared(false);
    ...
    $container->autowire(\MailPoet\Automation\Integrations\MailPoet\Triggers\OrderStatusChangedTrigger::class)->setPublic(true)->setShared(false);
