...
class BlackFridayNotice {
  ...
  const DATE_FROM = '2025-11-26 14:00:00 UTC';
  const DATE_TO = '2025-12-02 14:00:00 UTC';
  const PARAM_REF = 'sale-bfcm-2025-plugin';
  const PARAM_UTM_CAMPAIGN = 'sale_bfcm_2025';
  ...
  private function display() {
    ...
    $body = '<h5 class="mailpoet-h5">' . __('Our Black Friday sale is live. Save up to 40% when you switch to or upgrade an annual plan — no coupon needed. Offer ends at 2 PM UTC, 2 December.', 'mailpoet') . '</h5>';
