...
class PreprocessorTest extends \MailPoetUnitTest {
  public function testProcessWooCommerceHeadingBlock() {
    ...
    $dynamicProducts = Stub::make(DynamicProductsBlock::class);
      ...
      'blocks' => [
        [
          ...
          'blocks' => [
            [
              'type' => 'text',
              'text' => Preprocessor::WC_HEADING_BEFORE . '<h1 id="mailpoet-woo-email-header" style="color:{base_text_color};">[mailpoet_woocommerce_heading_placeholder]</h1>' . Preprocessor::WC_HEADING_AFTER,
            ],
          ],
        ],
      ],
