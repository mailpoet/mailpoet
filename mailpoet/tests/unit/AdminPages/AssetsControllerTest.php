...
class AssetsControllerTest extends \MailPoetUnitTest {
  ...
  public function testItFallsBackWhenGeneratedAssetDataIsMalformed(): void {
    file_put_contents($this->getFormEditorAssetDataPath(), '{"dependencies":');
  ...
  public function testItFallsBackWhenGeneratedAssetDataIsNotAnObject(): void {
    file_put_contents($this->getFormEditorAssetDataPath(), '"not an object"');
