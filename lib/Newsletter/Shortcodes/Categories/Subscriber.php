...
class Subscriber {
  static function process(
    ...
    switch($action) {
      case 'firstname':
        return ($subscriber && !empty($subscriber->first_name)) ? $subscriber->first_name : $default_value;
      case 'lastname':
        return ($subscriber && !empty($subscriber->last_name)) ? $subscriber->last_name : $default_value;
      case 'email':
