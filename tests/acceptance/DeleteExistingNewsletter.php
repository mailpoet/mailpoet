...
class DeleteExistingNewsletterCest {
  function deleteExistingNewsletter(\AcceptanceTester $I) {
	...
	$I->click('Move to trash', '[data-automation-id="listing_item_1"]');
	$I->wait(15);
	$I->click('Trash');
	$I->seeInCurrentUrl('/sort_by[sent_at]/sort_order[desc]/group[trash]');
  }
}