...
const ListHeading = () => (
  <>
    <TopBarWithBeamer>
      <Link className="mailpoet-button mailpoet-button-secondary" to="/new">
        {plusIcon}
        <span>{MailPoet.I18n.t('new')}</span>
      </Link>
      <Link className="mailpoet-button mailpoet-button-secondary" to="/new-segment" data-automation-id="new-segment">
        {plusIcon}
